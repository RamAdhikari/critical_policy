class critical_policy {
  ...
  registry_value { 'DisableEnterpriseAuthProxy':
    key   => 'HKLM\SOFTWARE\Policies\Microsoft\Windows\DataCollection',
    value => 'DisableEnterpriseAuthProxy',
    data  => '1',
    type  => dword,
    }
registry_value { 'ForceDefenderPassiveMode':
  ...
  registry_value{'MDEKEY2':
    key   => 'HKLM\SYSTEM\CurrentControlSet\Control\WMI\Security',
    value => '14f8138e-3b61-580b-544b-2609378ae460',
    type => binary,
  ...
  registry_value{'MDEKEY3':
    key   => 'HKLM\SYSTEM\CurrentControlSet\Control\WMI\Security',
    value => 'cb2ff72d-d4e4-585d-33f9-f3a395c40be7',
    type => binary,
    data  => '01 00 04 80 44 00 00 00 54 00 00 00 00 00 00 00 14 00 00 00 02 00 30 00 02 00 00 00 00 00 14 00 ff 0f 12 00 01 01 00 00 00 00 00 05 12 00 00 00 00 00 14 00 e1 04 12 00 01 01 00 00 00 00 00 05 0b 00 00 00 01 02 00 00 00 00 00 05 20 00 00 00 20 02 00 00 01 02 00 00 00 00 00 05 20 00 00 00 20 02 00 00',
    }
  registry_value { 'MDEKEY':
    key   => 'HKLM\SOFTWARE\Policies\Microsoft\Windows Advanced Threat Protection',
